...
module.exports = {
  ...
  glogs: {
    ...
    help: {
        title: () => `ℹ InviteCount's Help Page (Admin Only)`,
        ...
        admin: {
            ...
            content: (prefix) => "> `addbonus`, `removebonus`, `sync-invites`, `removeinvites`, `restoreinvites`, `setprefix`, `config`"},
        // Join DM Messages
        joinDM: {
            title: () => `💻 **General**`,
    ...
    credits: {
        ...
        dev: {
            title: () => `**Developers :**`,
            content: (uptime) => `[AjieDev](https://dsc.gg/ajidevserver)`
        },
        statistics: {
            title: () => `**Inspired from :**`,
            content: (guilds, users, channels, ping, ram, shardID) => `[DNet Techonolgies](about:blank)`
        },
        link: {
